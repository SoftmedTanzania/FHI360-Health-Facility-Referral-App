...
public class TbClientDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() != null){
            ...
            if (currentReferral != null){
                ...
                new TbClientDetailsActivity.patientDetailsTask(baseDatabase, currentReferral.getPatient_id()).execute();
            }
        }
    ...
    private void saveReferalInformation(){
        if (servicesOfferedEt.getText().toString().isEmpty()){
            ...
            TbClientDetailsActivity.UpdateReferralTask updateReferralTask = new TbClientDetailsActivity.UpdateReferralTask(currentReferral, baseDatabase);
    ...
    private void referalDialogueEvents(){
        ...
        final View mView = LayoutInflater.from(TbClientDetailsActivity.this).inflate(R.layout.custom_dialogue_layout, null);
