...
public class MonthOne extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView;
        rootView    = inflater.inflate(R.layout.fragment_month_one, container, false);
        setUpView(rootView);

        final String[] tbTypes = {TB_NEGATIVE, TB_SCANTY, TB_1_PLUS, TB_2_PLUS, TB_3_PLUS};
        ArrayAdapter<String> spinAdapter = new ArrayAdapter<String>(MonthOne.this.getActivity(), R.layout.simple_spinner_item_black, tbTypes);
