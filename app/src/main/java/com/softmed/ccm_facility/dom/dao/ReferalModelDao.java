...
import com.softmed.ccm_facility.utils.DateConverter;
...
public interface ReferalModelDao {
    ...
    //Used in OPD
    @Query("select * from Referral where referralType in (:sourceID) and facilityId = :requestingFacilityID and referralStatus = 0 order by appointmentDate asc")
