...
public class ChwReferralsReportFragment extends Fragment {
        ...
        new AsyncTask<Void, Void, Void>(){
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                for (RowView row : rowViewList){
                    ...
                    View tableview = View.inflate(ChwReferralsReportFragment.this.getActivity(), R.layout.single_service_report_table_item, null);
